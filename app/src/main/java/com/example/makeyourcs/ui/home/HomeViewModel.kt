...
//    var subIntroduce = ObservableField<String>()
   ...
   // var authListener: AuthListener? = null
    ...
    init{
        _imgList.add(ImageVo("1", R.drawable.ic_7,66.toString()))
        _imgList.add(ImageVo("2", R.drawable.ic_5,64.toString()))
        _imgList.add(ImageVo("3", R.drawable.ic_4,63.toString()))
        _imgList.add(ImageVo("4", R.drawable.ic_1,60.toString()))
        _imgList.add(ImageVo("5", R.drawable.ic_2,61.toString()))
        _imgList.add(ImageVo("6", R.drawable.ic_3,62.toString()))
        _imgList.add(ImageVo("7", R.drawable.ic_6,65.toString()))
